...
public class ConvenienceMethod {
    public static void main(String[] args) {
       ...
       // Predicate<String> brownEggs = str->str.contains("eggs") && str.contains("brown");
        Predicate<String> brownEggs = egg.and(brown);
        System.out.println(brownEggs.test("eggbrown"));

        // Predicate<String> brownEggs = str->str.contains("eggs") && !str.contains("brown");
        Predicate<String> othereEggs = egg.and(brown.negate());
        ...
        System.out.println(combined2.apply(3)); // (3+1) *2
    }
}
